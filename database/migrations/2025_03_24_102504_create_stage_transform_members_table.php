...
return new class extends Migration
{
    ...
    {
        return app(\App\Models\ETL\StageTransformMember::class)->getTable();
    }
    ...
    public function up(): void
    {
        Schema::create(self::getTableName(), function (Blueprint $table) {
            ...
            $table->foreignIdFor(\App\Models\ETL\StageExtractMember::class, 'stage_extract_id')
                ->references('id')->on(app(\App\Models\ETL\StageExtractMember::class)->getTable());
            $table->unsignedBigInteger('member_id', false)->nullable();
